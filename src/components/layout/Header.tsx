...
export function Header() {
  ...
  return (
    <>
      ...
      <div className="bg-navy-deep border-b border-gold/25 relative z-40 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-center h-10">
            <span className="text-gold text-[12px] font-body font-bold tracking-[2.5px] uppercase">
      ...
      <header className={`sticky top-10 z-50 transition-all duration-300 ${
        scrolled 
