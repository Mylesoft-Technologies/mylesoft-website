          ...
          <div className="section-padding relative z-10">
            <div className="text-center mb-8 fade-in">
              <div className="inline-flex items-center gap-2 bg-gold/10 backdrop-blur-sm px-4 py-2 rounded-full border border-gold/30 mb-4">
                <Icon name="heart" className="w-5 h-5 text-gold" />
                <span className="text-gold font-body font-semibold">Healthcare Management Solution</span>
              </div>
              <h1 className="heading-1 mb-4 fade-in text-white">MylesCare</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="text-white">
                <p className="text-xl text-navy-100 leading-relaxed mb-8 slide-up">
                  Streamline healthcare delivery with AI-powered diagnostics, comprehensive patient records, and automated appointment scheduling. MylesCare revolutionizes hospital operations for better patient outcomes.
                </p>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 mb-8 border border-white/20">
                  <h3 className="text-lg font-semibold text-white mb-4">Healthcare Features</h3>
